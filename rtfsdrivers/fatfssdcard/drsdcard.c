...
int sdcard_unit=0;
    ...
    {
        pc_rtfs_media_alert((void *) &rtfs_sdcard_is_initialized,RTFS_ALERT_EJECT,0);
    ...
    if (sdcard_driveflags[sdcard_unit] & SDCARD_INSERTED)
    {
      ...
      {
         RTFS_PRINT_STRING_1((byte *)"rtsdcard_device_open  failed.", PRFLG_NL);
      }
    }
}
...
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:90: undefined reference to `rtsdcard_driver_attach'
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:121: undefined reference to `rtsdcard_device_open'
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:125: undefined reference to `rtp_printf'
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:159: undefined reference to `rtsdcard_device_read'
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:161: undefined reference to `rtsdcard_device_write'
///media/sf_0a_share_with_virtual_box/ebs/gitsources/rtfsprofatfilesystem/rtfsprojects/amat/rtfsdemo/../../../rtfsdrivers/fatfssdcard/drsdcard.c:208: undefined reference to `rtsdcard_device_media_parms'
